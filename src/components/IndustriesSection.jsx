...
export default function IndustriesSection() {
  return (
    <div className="px-6 py-16 bg-white border-t">
      <div className="max-w-7xl mx-auto grid md:grid-cols-3 lg:grid-cols-6 gap-12">
        ...
        <div>
          <h3 className="font-bold text-blue-700 mb-2 tracking-wide">FOOD & HOSPITALITY</h3>
        ...
        <div>
          <h3 className="font-bold text-rose-600 mb-2 tracking-wide">REAL ESTATE</h3>
        ...
        <div>
          <h3 className="font-bold text-purple-700 mb-2 tracking-wide">CONSULTING</h3>
        ...
        <div>
          <h3 className="font-bold text-indigo-700 mb-2 tracking-wide">MANUFACTURING</h3>
