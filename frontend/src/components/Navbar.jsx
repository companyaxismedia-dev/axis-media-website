      ...
      >
        <nav className="w-full h-full">
          <div className="max-w-7xl mx-auto px-6 h-full flex items-center">
            ...
            {/* ================= LOGO ================= */}
           <NavLink to="/" className="flex items-center h-full shrink-0 mr-10">
              <img
                src={logo}
            ...
            {/* ================= DESKTOP MENU ================= */}
            <ul className="hidden md:flex items-center gap-8 font-semibold text-white text-[15px]">
              ...
              <NavLink to="/contact" className="bg-blue-700 px-4 py-2 rounded-xl whitespace-nowrap">
                Get a Quote
              </NavLink>
