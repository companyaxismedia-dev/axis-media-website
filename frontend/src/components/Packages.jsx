...
const packages = [
  {
    ...
    duration: "One Time",
    description:
      "The Basic Website package is ideal for startups, freelancers and small local businesses that want a simple but professional online presence. It includes essential website setup, basic SEO, responsive design, hosting support and branding elements that help your business establish trust and visibility online.",
    features: [
      "Free TLD Domain",
      "Free Cloud Hosting",
      "Basic SEO",
...

  {
    ...
    highlight: true,
    description:
      "The Plus Website package is suitable for businesses that want a more advanced website with stronger optimization, content support and customer-facing functionality. It includes admin access, social media integration, mobile optimization and SEO-ready structure to support better growth and improved digital visibility.",
    features: [
      "Free Domain + Hosting",
      "SSL Certificate",
      "10 Pages Website",
...

  {
    ...
    duration: "One Time",
    description:
      "The Pro Business Website package is built for serious brands that need a premium digital presence with stronger branding, advanced SEO and higher performance. It is ideal for businesses that want a larger website, better communication tools, stronger optimization and a polished online identity that supports long-term growth.",
    features: [
      "Domain + Hosting",
      "SEO Optimized",
      "Mobile Optimization",
...

  {
    ...
    duration: "Premium",
    description:
      "The E-Commerce Starter package is perfect for businesses launching their first online store and looking for essential selling features. It includes product upload support, order handling, payment options, customer login and admin dashboard access so you can start selling online with confidence and control.",
    features: [
      "Free .com Domain",
      "Advanced Hosting",
      "20 Pages Website",
...

  {
    ...
    duration: "One Time",
    description:
      "The E-Commerce Pro package is built for advanced online stores that need complete functionality, scalability and business automation. It includes unlimited product support, payment gateway integration, order and stock management, invoice tools, advanced SEO and long-term support for serious e-commerce growth.",
    features: [
      "10 Products Upload",
      "COD + Online Payment",
      "Admin Dashboard",
